...
var pokeGoals = {
	...
	"Entei, Raikou, or Suicune": [["ENTEI", "RAIKOU", "SUICUNE"]],
	"Exeggutor or Sunflora ": [["EXEGGUTOR", "SUNFLORA"], ["EXEGGCUTE", "SUNKERN"]],
...
var route46trainers = [433, 460];
var lighthousetrainers = [82, 84, 102, 220, 224, 316, 317, 318, 319];
var nationalparktrainers = [55, 101, 496, 526];
var phonebooktrainers = [41, 55, 57, 107, 234, 238, 251, 256, 354, 393, 424, 425, 451]
...
var softsandtrainers = [140, 141, 152];
var cooltrainers = [116, 136, 150];
var coincasetrainers = [185, 329];
var mineralbadgetrainers = [6, 102, 220, 224]
var glacierbadgetrainers = [5, 225]
var risingbadgetrainers = [8, 118, 119, 138, 139]
var callsailortrainer = [224, 316]
...
var trainerInfo = {
	...
	64: ["SCHOOLBOY CHAD", "ROUTE 38", "Route 38 trainer"],
	...
	83: ["BIRD KEEPER TOBY", "ROUTE 38", "Route 38 trainer"],
	...
	107: ["LASS DANA", "ROUTE 38", "Call Lass trainer/Phonebook trainer"],
	116: ["COOLTRAINER NICK", "UNION CAVE", "Union Cave Cooltrainer"],
	...
	136: ["COOLTRAINER GWEN", "UNION CAVE", "Union Cave Cooltrainer"],
	138: ["COOLTRAINER FRAN", "BLACKTORN CITY GYM", "Rising Badge trainer"],
	139: ["COOLTRAINER LOLA", "BLACKTORN CITY GYM", "Rising Badge trainer"],
	140: ["COOLTRAINER KATE", "ROUTE 34", "Soft Sand trainer"],
	141: ["COOLTRAINER IRENE", "ROUTE 34", "Soft Sand trainer"],
	150: ["COOLTRAINER EMMA", "UNION CAVE", "Union Cave Cooltrainer"],
	151: ["COOLTRAINER CYBIL", "ROUTE 44", "Route 44 trainer"],
	152: ["COOLTRAINER JENN", "ROUTE 34", "Soft Sand trainer"],
	172: ["BEAUTY VALERIE", "ROUTE 38", "Route 38 trainer"],
	173: ["BEAUTY OLIVIA", "ROUTE 38", "Route 38 trainer"],
	...
	256: ["FISHER TULLY", "ROUTE 42", "Phonebook trainer"],
	...
	329: ["SUPER NERD ERIC", "GOLDENROD TUNNEL", "Coin Case trainer"],
	...
	460: ["CAMPER TED", "ROUTE 46", "Route 46 trainer"],
...
function generateTrainersArray(){
	...
	if(document.getElementById("38trainers").checked) trainersArray = trainersArray.concat(route38trainers);
	if(document.getElementById("46trainers").checked) trainersArray = trainersArray.concat(route46trainers);
	...
	if(document.getElementById("softsand").checked) trainersArray = trainersArray.concat(softsandtrainers);
	if(document.getElementById("cool").checked) trainersArray = trainersArray.concat(cooltrainers);
	if(document.getElementById("coincase").checked) trainersArray = trainersArray.concat(coincasetrainers);
